...
const Hero: React.FC = () => {
  return (
    <section
      ...
      data-aos="fade-in" // Adding animation effect
    >
      {/* Background video */}
      <video
        autoPlay
      ...
      <div className="relative z-10 flex justify-center items-center text-center h-full">
        <div className="max-w-4xl">
          ...
          <p className="mt-4 text-xl text-gray-300 max-w-lg mx-auto">
            I&apos;m a BCA student passionate about technology, problem-solving,
            and developing innovative solutions. Currently working on various
            exciting projects.
          </p>
        </div>
      </div>
